...
module Conditions
  WITH_VK1 = { type: 'variable_if', name: VirtualKeys::VK1, value: Values::ON }.freeze
  WITH_VK2 = { type: 'variable_if', name: VirtualKeys::VK2, value: Values::ON }.freeze
...
def rule_for_vscode_vk4(key_code, command_name)
  {
    ...
    manipulators: [
      {
        from: { key_code: key_code },
        to: [{ key_code: key_code, modifiers: %w[control shift option command] }],
      },
    ].vscode_vk4.basic,
  }
end
...
h = {
  ...
  rules: [
    ...
    },
    {
      ...
      manipulators: [
        { from: { key_code: 's' }, to: [{ key_code: 'j', modifiers: %w[shift control] }] },
        { from: { key_code: 'd' }, to: [{ key_code: 'semicolon', modifiers: %w[shift control] }] },
      ].vk1.basic,
    },
    {
    ...
    },
    {
      ...
      manipulators: [
        { from: { key_code: 'o' }, to: [{ key_code: 'tab', modifiers: %w[control shift] }] },
    ...
    },
    {
      ...
      manipulators: [
        ...
        { from: { key_code: 'x' }, to: [{ key_code: 'v', modifiers: %w[command shift option] }] },
      ].vk1.basic,
    },
    {
    ...
    },
    {
      ...
      manipulators: [
        ...
        { from: { key_code: 'd' }, to: [{ key_code: 'tab', modifiers: %w[command shift] }] },
      ].vk2.basic,
    },
    {
      ...
      manipulators: [
        ...
        { from: { key_code: 'a' }, to: [{ key_code: 'tab', modifiers: %w[control shift] }] },
      ].vk2.basic,
    },
    {
      description: '[VK2] 9/0 -> command+shift+;/command+hyphen',
      manipulators: [
        { from: { key_code: '9' }, to: [{ key_code: 'semicolon', modifiers: %w[command shift] }] },
    ...
    },
    {
      ...
      manipulators: [
        { from: { key_code: 'h', modifiers: { mandatory: ['control'] } }, to: [{ key_code: 'left_arrow', modifiers: %w[command control option] }] },
        { from: { key_code: 'o', modifiers: { mandatory: ['control'] } }, to: [{ key_code: 'right_arrow', modifiers: %w[command control option] }] },
        { from: { key_code: 'n', modifiers: { mandatory: ['control'] } }, to: [{ key_code: 'down_arrow', modifiers: %w[command control option] }] },
        { from: { key_code: 'p', modifiers: { mandatory: ['control'] } }, to: [{ key_code: 'up_arrow', modifiers: %w[command control option] }] },
        { from: { key_code: 'u', modifiers: { mandatory: ['control'] } }, to: [{ key_code: '1', modifiers: %w[control option command] }] },
        { from: { key_code: 'i', modifiers: { mandatory: ['control'] } }, to: [{ key_code: '2', modifiers: %w[control option command] }] },
        { from: { key_code: 'm', modifiers: { mandatory: ['control'] } }, to: [{ key_code: '3', modifiers: %w[control option command] }] },
        { from: { key_code: 'comma', modifiers: { mandatory: ['control'] } }, to: [{ key_code: '4', modifiers: %w[control option command] }] },
      ].vk2.basic,
    },
    {
    ...
    {
      description: '[VK2] t -> Microsoft To Do.app',
      manipulators: [
        {
          from: { key_code: 't' },
          to: [{ shell_command: "open -a 'Microsoft To Do.app'" }],
        },
      ].vk2.basic,
    },
    {
